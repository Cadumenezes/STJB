...
add column if not exists plan text default 'starter' check (plan in ('starter', 'pro')),
add column if not exists expires_at date;

-- 2. Atualiza a trigger para colocar os usuários novos automaticamente no 'starter' (caso precisem)
