...
export default function Checkout() {
  ...
  async function handleSubscribe(plan: 'bronze' | 'prata' | 'ouro' | 'diamante') {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white relative selection:bg-purple-500/30 overflow-x-hidden p-6 sm:p-12 flex flex-col justify-between">
      ...
      <main className="relative z-10 max-w-5xl w-full mx-auto flex-1 flex flex-col justify-center items-center">
        ...
        {/* Pricing Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-5xl items-stretch">
          ...
          <div className="p-6 rounded-3xl bg-white/5 border border-white/10 flex flex-col justify-between hover:border-white/20 transition-all hover:scale-[1.01]">
            <div>
              <div className="flex justify-between items-start mb-2">
                <h3 className="text-xl font-black">Plano Bronze</h3>
              </div>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl border-2 border-white/10 font-black text-xs flex items-center justify-center gap-2 hover:bg-white hover:text-black hover:border-white disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
          ...
          <div className="p-6 rounded-3xl bg-white/5 border border-white/10 flex flex-col justify-between hover:border-white/20 transition-all hover:scale-[1.01]">
            <div>
              <div className="flex justify-between items-start mb-2">
                <h3 className="text-xl font-black">Plano Prata</h3>
              </div>
          ...
          {/* Ouro Plan */}
          <div className="p-6 rounded-3xl bg-gradient-to-b from-purple-600/20 to-pink-600/10 border-2 border-purple-500 relative flex flex-col justify-between hover:shadow-[0_0_50px_rgba(168,85,247,0.15)] transition-all hover:scale-[1.02]">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-3 py-0.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-[9px] font-black uppercase tracking-widest shadow-lg">
              Mais Escolhido
            </div>
            ...
            <button
              ...
              disabled={processingPlan !== null}
              className="w-full py-3 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 font-black text-xs text-white flex items-center justify-center gap-2 hover:shadow-[0_0_35px_rgba(168,85,247,0.4)] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              {processingPlan === 'ouro' ? (
                <>
                  <Loader2 className="h-4 w-4 animate-spin" />
          ...
          <div className="p-6 rounded-3xl bg-white/5 border border-white/10 flex flex-col justify-between hover:border-white/20 transition-all hover:scale-[1.01]">
            <div>
              <div className="flex justify-between items-start mb-2">
                <h3 className="text-xl font-black">Plano Diamante</h3>
              </div>
